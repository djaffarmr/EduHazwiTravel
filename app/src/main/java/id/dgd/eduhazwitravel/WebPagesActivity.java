...
public class WebPagesActivity extends AppCompatActivity {
    ...
    public void loadWeb() {
        ...
        switch (extraString) {
            case "pesawat":
                url = "http://booking.klikmbc.co.id/booking/flights/page/formagen.php?s=eduhazwi.com&d=hotel-kereta-antarjemput-registeragen-umroh-bustravel";
                break;
            case "kereta":
                url = "http://booking.klikmbc.co.id/booking/flights/page/formagen.php?s=eduhazwi.com&d=pesawat-hotel-antarjemput-registeragen-umroh-bustravel";
                break;
            case "hotel":
                url = "http://booking.klikmbc.co.id/booking/flights/page/formagen.php?s=eduhazwi.com&d=pesawat-kereta-antarjemput-registeragen-umroh-bustravel";
                break;
            case "umroh":
                url = "http://eduhazwi.com/umroh";
                break;
            case "bus":
                url = "http://transaksi.klikmbc.co.id/bustravel/index.php?s=eduhazwi.com";
                break;
            case "transport":
                url = "http://booking.klikmbc.co.id/booking/flights/page/formagen.php?s=eduhazwi.com&d=pesawat-hotel-kereta-registeragen-umroh-bustravel";
                break;
            case "ppob":
            ...
            case "pulsa":
                ...
                break;
            case "tur":
                url = "http://tour.klikmbc.co.id/?s=tour.klikmbc.co.id?s=eduhazwi.com";
                break;
            case "agen":
                url = "http://booking.klikmbc.co.id/booking/flights/page/formagen.php?s=eduhazwi.com&d=pesawat-kereta-antarjemput-umroh-bustravel-hotel";
                break;
            case "kontak":
                url = "http://eduhazwi.com/contact-us";
                break;
        }
